...
if (y > obj_house.y) {
    if (y > obj_player.y && collision_rectangle(x - sprite_xoffset, y + 7 - sprite_yoffset, x + sprite_xoffset, y + 7 + sprite_yoffset, obj_player, false, false)) { //overlap if player is behind (lower y pos)
        depth = 10;
